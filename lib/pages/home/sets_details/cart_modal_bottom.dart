...
void showCartModal(BuildContext context, CartBloc bloc, PriceModel? initialPrice, ProductDetailModel products ) {
  showModalBottomSheet(
   context: context,
    builder: (context) {
      return CartBottomModal(bloc: bloc, selectedState: initialPrice, products: products,);
    }
  );
}
...
class CartBottomModal extends StatefulWidget {
  const CartBottomModal({super.key ,required this.bloc, required this.selectedState,
